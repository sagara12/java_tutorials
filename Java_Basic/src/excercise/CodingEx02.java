...
public class CodingEx02 {
	...
	public static String convert(String input) {
    	...
    	while (matcher.find()) {
    		...
    		//buffer += input.substring(startIndex, matchIndex) + "_" + input.substring(matchIndex, matchIndex+1).toLowerCase());
    		buffer.append(input.substring(startIndex, matchIndex) + "_" 
    				+ input.substring(matchIndex, matchIndex+1).toLowerCase());
